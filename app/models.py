...
class Role(db.Model):
    ...
    # This constructor sets permission's value to 0 (zero) since SQLAlchemy will set it to None by default;
    # If an initial value isin't provided in the constructors argument.
    ...
    # permission management in the Role module
...
class User(UserMixin,db.Model):
    ...
    # A many-to-many relationship implemented as two one-to-many relationships.
    ...
    followers = db.relationship('Follow',
                                ...
                                lazy='dynamic',
                                cascade='all, delete-orphan')
    # A one to many relationship from users to comments
...
class Post(db.Model):
    ...
    # A one to many relationship from posts to comments.
    ...
    # Creating a blog post from JSON (Deserialization).
    @staticmethod
