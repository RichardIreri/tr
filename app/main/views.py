...
# Profile page route with blogs and support pagination
...
# Comments moderation route moderate page
@main.route('/moderate')
@login_required
...
# Comments moderation routes for toggle enable button      
...
# Comments moderation routes for toggle disable button      
...
# Unfollow route and view function
...
# Followers routes and view function
...
# Followed by routes and view function (Endpoint)
